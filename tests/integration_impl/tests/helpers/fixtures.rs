use super::dirs::*;
use crate::integration_impl::loader::Loader;
use crate::integration_impl::{
    bindings::Language, fixtures::prepare, tree_sitter_highlight::HighlightConfiguration,
};
...
pub fn get_language(name: &str) -> Language {
    prepare().expect("cannot prepare grammars directory");
    TEST_LOADER
