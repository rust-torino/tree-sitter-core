...
use crate::integration_impl::generate::grammars::{ExternalToken, Variable, VariableType};
use crate::integration_impl::generate::rules::{MetadataParams, Rule, Symbol, SymbolType};
...
mod test {
    use super::*;
    use crate::integration_impl::generate::grammars::VariableType;
