...
use crate::integration_impl::error::{Error, Result};
use crate::integration_impl::generate::grammars::{LexicalGrammar, LexicalVariable};
use crate::integration_impl::generate::nfa::{CharacterSet, Nfa, NfaState};
use crate::integration_impl::generate::rules::Rule;
...
mod tests {
    use super::*;
    use crate::integration_impl::generate::grammars::Variable;
    use crate::integration_impl::generate::nfa::{NfaCursor, NfaTransition};
