use crate::integration_impl::generate::build_tables::item::TokenSetDisplay;
use crate::integration_impl::generate::grammars::{LexicalGrammar, SyntaxGrammar};
use crate::integration_impl::generate::nfa::{CharacterSet, NfaCursor, NfaTransition};
use crate::integration_impl::generate::rules::TokenSet;
...
mod tests {
    use super::*;
    use crate::integration_impl::generate::grammars::{Variable, VariableType};
    use crate::integration_impl::generate::prepare_grammar::{
        expand_tokens, ExtractedLexicalGrammar,
    };
    use crate::integration_impl::generate::rules::{Rule, Symbol};
