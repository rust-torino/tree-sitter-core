 ...
 -> Length {
    if (*self_0).cursor.stack.size.wrapping_sub(1 as libc::c_int as
        ...
        __assert_fail(b"(uint32_t)(&self->cursor.stack)->size - 1 < (&self->cursor.stack)->size\x00"
                      ...
                      b"././get_changed_ranges.c\x00" as *const u8 as
                          *const libc::c_char,
    ...
    loop  {
        ...
        let mut next_child: *const Subtree =
            &mut *(*(*parent).ptr).c2rust_unnamed.c2rust_unnamed.children.offset(child_index
                                                                                     ...
                                                                                     isize)
                as *mut Subtree;
        array__grow(&mut (*self_0).cursor.stack as *mut C2RustUnnamed_23 as
...
unsafe extern "C" fn iterator_new(mut cursor: *mut TreeCursor,
 ...
 -> Iterator_0 {
    ...
    array__grow(&mut (*cursor).stack as *mut C2RustUnnamed_23 as
                    *mut VoidArray, 1 as libc::c_int as size_t,
    ...
    if symbol as libc::c_int == -(1 as libc::c_int) as TSSymbol as libc::c_int
        ...
        if count > 0 as libc::c_int as libc::c_uint {
            ...
            if action.type_0() as libc::c_int ==
                ...
                return if action.params.c2rust_unnamed.extra() as libc::c_int
                              != 0 {
                           state as libc::c_int
                       } else {
...
unsafe extern "C" fn reusable_node_advance(mut self_0: *mut ReusableNode) {
    if (*self_0).stack.size.wrapping_sub(1 as libc::c_int as libc::c_uint) <
        ...
        __assert_fail(b"(uint32_t)(&self->stack)->size - 1 < (&self->stack)->size\x00"
                          as *const u8 as *const libc::c_char,
                      b"././reusable_node.h\x00" as *const u8 as
                          *const libc::c_char,
...
unsafe extern "C" fn ts_parser__recover(mut self_0: *mut TSParser,
  ...
  // be counted in error cost calculations.
    ...
    if n > 0 as libc::c_int as libc::c_uint &&
           (*actions.offset(n.wrapping_sub(1 as libc::c_int as libc::c_uint)
               ...
               TSParseActionTypeShift as libc::c_int &&
           (*actions.offset(n.wrapping_sub(1 as libc::c_int as libc::c_uint)
                                as isize)).params.c2rust_unnamed.extra() as
               libc::c_int != 0 {
  ...
  // ERROR.
    ...
    // arbitrarily and discard the rest.
        ...
        *(*pop.contents.offset(0 as libc::c_int as
                                   isize)).subtrees.contents.offset(fresh21 as
                                                                        isize)
            ...
            while (symbol as libc::c_int) < end_symbol as libc::c_int {
                ...
                while i_1 < entry.action_count {
                    ...
                    match action.type_0() as libc::c_int {
                        ...
                        1 => {
                            if action.params.c2rust_unnamed_0.child_count as
                                   libc::c_int > 0 as libc::c_int {
                                ts_reduce_action_set_add(&mut (*self_0).reduce_actions,
                                                         {
                                                             let mut init =
                                                                 ReduceAction{count:
                                                                                  action.params.c2rust_unnamed_0.child_count
                                                                                      as
                                                                                      uint32_t,
                                                                              symbol:
                                                                                  action.params.c2rust_unnamed_0.symbol,
                                                                              dynamic_precedence:
                                                                                  action.params.c2rust_unnamed_0.dynamic_precedence
                                                                                      as
                                                                                      libc::c_int,
                                                                              production_id:
                                                                                  action.params.c2rust_unnamed_0.production_id
                                                                                      as
                                                                                      libc::c_ushort,};
                                                             init
                                                         });
                ...
                1 => {
                    ...
                    if (*self_0).lexer.logger.log.is_some() ||
                        ...
                        snprintf((*self_0).lexer.debug_buffer.as_mut_ptr(),
                                 ...
                                 ts_language_symbol_name((*self_0).language,
                                                         action.params.c2rust_unnamed_0.symbol),
                                 action.params.c2rust_unnamed_0.child_count as
                                     libc::c_int);
                        ts_parser__log(self_0);
                    }
                    let mut reduction_version: StackVersion =
...
unsafe extern "C" fn capture_list_pool_reset(mut self_0: *mut CaptureListPool,
    ...
    let mut total_size: uint32_t =
        (MAX_STATE_COUNT as libc::c_int * list_size as libc::c_int) as
            uint32_t;
    array__reserve(&mut (*self_0).list as *mut C2RustUnnamed_18 as
                       *mut VoidArray,
...
unsafe extern "C" fn capture_list_pool_delete(mut self_0:
                                                  *mut CaptureListPool) {
    array__delete(&mut (*self_0).list as *mut C2RustUnnamed_18 as
                      *mut VoidArray);
}
unsafe extern "C" fn capture_list_pool_get(mut self_0: *mut CaptureListPool,
                                           mut id: uint16_t)
 -> *mut TSQueryCapture {
    return &mut *(*self_0).list.contents.offset((id as
                                                     libc::c_uint).wrapping_mul((*self_0).list.size.wrapping_div(MAX_STATE_COUNT
                                                                                                                     as
                                                                                                                     libc::c_uint))
                                                    as isize) as
               *mut TSQueryCapture;
...
unsafe extern "C" fn query_step__new(mut symbol: TSSymbol,
    ...
    return {
               let mut init =
                   QueryStep{depth_contains_captures_is_immediate_is_last:
                                 [0; 2],
                             symbol: symbol,
...
unsafe extern "C" fn ts_query__parse_predicate(mut self_0: *mut TSQuery,
 ...
 -> TSQueryError {
    if (*stream).next == ')' as i32 { return PARENT_DONE }
 ...
 -> TSQueryError {
    ...
    // zero-or-more predicates.
            if (*stream).next == '(' as i32 &&
                ...
                if e as u64 != 0 { return e }
                // Parse the predicates.
                stream_skip_whitespace(stream);
                loop  {
                    let mut e_0: TSQueryError =
                        ts_query__parse_predicate(self_0, stream);
                    if e_0 as libc::c_uint == PARENT_DONE as libc::c_uint {
                        stream_advance(stream);
                        stream_skip_whitespace(stream);
                        return TSQueryErrorNone
                    } else { if e_0 as u64 != 0 { return e_0 } }
                }
            }
            ...
            if (*stream).next == '*' as i32 {
                ...
                let mut length: uint32_t =
                    (*stream).input.wrapping_offset_from(node_name) as
                        libc::c_long as uint32_t;
                symbol =
                    ts_language_symbol_for_name((*self_0).language, node_name,
                                                length,
                                                1 as libc::c_int != 0);
                if symbol == 0 {
            ...
            *(*self_0).steps.contents.offset(fresh36 as isize) =
            ...
            (*(*self_0).steps.contents.offset(step_index as isize)).field =
                field_id
        } else if (*stream).next == '*' as i32 {
            stream_advance(stream);
            stream_skip_whitespace(stream);
    ...
    while (*stream).next == '@' as i32 {
        ...
        let mut length_2: uint32_t =
            (*stream).input.wrapping_offset_from(capture_name) as libc::c_long
                as uint32_t;
        // Add the capture id to the first step of the pattern
        let mut capture_id: uint16_t =
            symbol_table_insert_name(&mut (*self_0).captures, capture_name,
                                     length_2);
        let mut step: *mut QueryStep =
 ...
 -> *mut TSQuery {
    ...
    *self_0 =
    ...
    while stream.input < stream.end {
        ...
        *(*self_0).start_bytes_by_pattern.contents.offset(fresh38 as isize) =
        ...
        *(*self_0).predicates_by_pattern.contents.offset(fresh39 as isize) =
            {
                let mut init =
    ...
    // and terminate.
        ...
        ts_query__pattern_map_insert(self_0,
                                     (*(*self_0).steps.contents.offset(start_step_index
                                                                           as
                                                                           isize)).symbol,
                                     start_step_index);
...
pub unsafe extern "C" fn ts_query_cursor_next_capture(mut self_0:
 ...
 -> bool {
    ...
    // is *definitely* before any capture in an *unfinished* pattern.
      ...
      // this position.
            let mut first_unfinished_capture_byte: uint32_t =
                4294967295 as libc::c_uint;
            let mut first_unfinished_pattern_index: uint32_t =
                4294967295 as libc::c_uint;
            ...
            while i < (*self_0).finished_states.size {
                ...
                if (*state).capture_count as libc::c_int >
                    ...
                    let mut capture_byte: uint32_t =
                        ts_node_start_byte((*captures.offset((*state).consumed_capture_count
                                                                 as
                                                                 isize)).node);
                    ...
                    array__erase(&mut (*self_0).finished_states as
                                     *mut C2RustUnnamed_19 as *mut VoidArray,
      ...
      // record the fact that the capture has been 'consumed'.
            ...
            if capture_list_pool_is_empty(&mut (*self_0).capture_list_pool) {
                ...
                array__erase(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                                 *mut VoidArray,
                             ::std::mem::size_of::<QueryState>() as
        ...
        if (*state).capture_count as libc::c_int > 0 as libc::c_int {
            let mut captures: *const TSQueryCapture =
                capture_list_pool_get(&mut (*self_0).capture_list_pool,
                                      (*state).capture_list_id);
            let mut capture_byte: uint32_t =
                ts_node_start_byte((*captures.offset(0 as libc::c_int as
                                                         isize)).node);
...
unsafe extern "C" fn ts_query__cursor_add_state(mut self_0:
                                                    *mut TSQueryCursor,
                                                mut pattern:
                                                    *const PatternEntry)
 -> bool {
    let mut list_id: uint32_t =
        capture_list_pool_acquire(&mut (*self_0).capture_list_pool) as
            uint32_t;
    if list_id == NONE as libc::c_uint {
        ...
        if ts_query_cursor__first_in_progress_capture(self_0,
                                                      ...
                                                      &mut pattern_index) {
            list_id =
                (*(*self_0).states.contents.offset(state_index as
                                                       isize)).capture_list_id
                    as uint32_t;
            array__erase(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                             *mut VoidArray,
    ...
    array__grow(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                    *mut VoidArray, 1 as libc::c_int as size_t,
                ::std::mem::size_of::<QueryState>() as libc::c_ulong);
    ...
    *(*self_0).states.contents.offset(fresh41 as isize) =
        {
            let mut init =
                QueryState{start_depth: (*self_0).depth as uint16_t,
...
unsafe extern "C" fn ts_query__cursor_copy_state(mut self_0:
 ...
 -> *mut QueryState {
    let mut new_list_id: uint32_t =
        capture_list_pool_acquire(&mut (*self_0).capture_list_pool) as
            uint32_t;
    if new_list_id == NONE as libc::c_uint { return 0 as *mut QueryState }
    array__grow(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                    *mut VoidArray, 1 as libc::c_int as size_t,
                ::std::mem::size_of::<QueryState>() as libc::c_ulong);
    ...
    *(*self_0).states.contents.offset(fresh42 as isize) = *state;
    if (*self_0).states.size.wrapping_sub(1 as libc::c_int as libc::c_uint) <
           (*self_0).states.size {
    } else {
        __assert_fail(b"(uint32_t)(&self->states)->size - 1 < (&self->states)->size\x00"
                          as *const u8 as *const libc::c_char,
                      b"././query.c\x00" as *const u8 as *const libc::c_char,
                      1208 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 77],
                                                &[libc::c_char; 77]>(b"QueryState *ts_query__cursor_copy_state(TSQueryCursor *, const QueryState *)\x00")).as_ptr());
    }
    let mut new_state: *mut QueryState =
        &mut *(*self_0).states.contents.offset((*self_0).states.size.wrapping_sub(1
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      libc::c_uint)
    ...
    let mut new_captures: *mut TSQueryCapture =
        capture_list_pool_get(&mut (*self_0).capture_list_pool,
                              new_list_id as uint16_t);
    memcpy(new_captures as *mut libc::c_void,
           old_captures as *const libc::c_void,
           ((*state).capture_count as
                libc::c_ulong).wrapping_mul(::std::mem::size_of::<TSQueryCapture>()
                                                as libc::c_ulong));
    return new_state;
}
#[inline]
            ...
            while i < n {
                ...
                let mut step: *mut QueryStep =
                    &mut *(*(*self_0).query).steps.contents.offset((*state).step_index
                                                                       ...
                                                                       isize)
                        as *mut QueryStep;
                if ((*state).start_depth as
                        uint32_t).wrapping_add((*step).depth() as uint32_t) >
                       (*self_0).depth {
                    capture_list_pool_release(&mut (*self_0).capture_list_pool,
                                              (*state).capture_list_id);
                    ...
                    if !(((*state_0).start_depth as
                        ...
                        if !node_does_match {
                                   ...
                                   later_sibling_can_match as libc::c_int != 0
                               {
                                let mut copy: *mut QueryState =
                                    ts_query__cursor_copy_state(self_0,
                                                                state_0);
                                if !copy.is_null() { next_state = copy }
                            }
                            let mut j: libc::c_uint =
                                0 as libc::c_int as libc::c_uint;
                            while j < 4 as libc::c_int as libc::c_uint {
                                ...
                                if (*step_2).capture_ids[j as usize] as
                                       libc::c_int == NONE as libc::c_int {
                                    break ;
                                }
                                let mut capture_list: *mut TSQueryCapture =
                                    capture_list_pool_get(&mut (*self_0).capture_list_pool,
                            ...
                            if (*next_step).depth() as libc::c_int ==
                                ...
                                *(*self_0).finished_states.contents.offset(fresh45
                                                                               as
                                                                               isize)
                                    = *next_state;
                                if next_state == state_0 {
                                    ...
                                    (*self_0).states.size =
                                        (*self_0).states.size.wrapping_sub(1)
                                }
                            }
                        }
                    }
...
pub unsafe extern "C" fn ts_query_cursor_next_match(mut self_0:
 ...
 -> bool {
    ...
    capture_list_pool_release(&mut (*self_0).capture_list_pool,
                              (*state).capture_list_id);
    array__erase(&mut (*self_0).finished_states as *mut C2RustUnnamed_19 as
                     *mut VoidArray,
                 ::std::mem::size_of::<QueryState>() as libc::c_ulong,
                 0 as libc::c_int as uint32_t);
    return 1 as libc::c_int != 0;
...
pub unsafe extern "C" fn ts_query_cursor_delete(mut self_0:
                                                    *mut TSQueryCursor) {
    array__delete(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                      *mut VoidArray);
    array__delete(&mut (*self_0).finished_states as *mut C2RustUnnamed_19 as
                      *mut VoidArray);
...
pub unsafe extern "C" fn ts_query_cursor_new() -> *mut TSQueryCursor {
    ...
    *self_0 =
    ...
    array__reserve(&mut (*self_0).states as *mut C2RustUnnamed_20 as
                       *mut VoidArray,
                   ::std::mem::size_of::<QueryState>() as libc::c_ulong,
                   MAX_STATE_COUNT as uint32_t);
    array__reserve(&mut (*self_0).finished_states as *mut C2RustUnnamed_19 as
                       *mut VoidArray,
                   ::std::mem::size_of::<QueryState>() as libc::c_ulong,
                   MAX_STATE_COUNT as uint32_t);
    return self_0;
            ...
            if should_stop {
                ...
                while j <= (*node).link_count as libc::c_uint {
                    ...
                    if j == (*node).link_count as libc::c_uint {
                        ...
                        *(*self_0).iterators.contents.offset(fresh52 as isize)
                            = current_iterator;
                        ...
                        11048769245176032998 => {
                            ...
                            if !link.subtree.ptr.is_null() {
                                if include_subtrees {
                                    ...
                                    *(*next_iterator).subtrees.contents.offset(fresh53
                                                                                   as
                                                                                   isize)
                                        = link.subtree;
                                    ts_subtree_retain(link.subtree);
...
pub unsafe extern "C" fn ts_stack_print_dot_graph(mut self_0: *mut Stack,
    ...
    let mut visited_nodes: C2RustUnnamed_21 =
        {
            let mut init =
                C2RustUnnamed_21{contents: 0 as *mut *mut StackNode,
                                 size: 0 as libc::c_int as uint32_t,
                                 capacity: 0 as libc::c_int as uint32_t,};
            init
        };
    ...
    while !all_iterators_done {
        ...
        while i_0 < (*self_0).iterators.size {
            ...
            if !node.is_null() {
                ...
                array__grow(&mut visited_nodes as *mut C2RustUnnamed_21 as
                                *mut VoidArray, 1 as libc::c_int as size_t,
                            ::std::mem::size_of::<*mut StackNode>() as
                                libc::c_ulong);
                ...
                let ref mut fresh61 =
                    *visited_nodes.contents.offset(fresh60 as isize);
                *fresh61 = node
            }
            i_0 = i_0.wrapping_add(1)
        }
    ...
    fprintf(f, b"}\n\x00" as *const u8 as *const libc::c_char);
    array__delete(&mut visited_nodes as *mut C2RustUnnamed_21 as
                      *mut VoidArray);
...
pub unsafe extern "C" fn ts_subtree_edit(mut self_0: Subtree,
 ...
 -> Subtree {
    let mut stack: C2RustUnnamed_22 =
        {
            let mut init =
                C2RustUnnamed_22{contents: 0 as *mut StackEntry_0,
                                 size: 0 as libc::c_int as uint32_t,
                                 capacity: 0 as libc::c_int as uint32_t,};
            init
        };
    array__grow(&mut stack as *mut C2RustUnnamed_22 as *mut VoidArray,
                1 as libc::c_int as size_t,
        ...
        *entry.tree = ts_subtree_from_mut(result);
        ...
        while i < n {
            ...
            if !(child_right.bytes.wrapping_add(ts_subtree_lookahead_bytes(*child))
                ...
                array__grow(&mut stack as *mut C2RustUnnamed_22 as
                                *mut VoidArray, 1 as libc::c_int as size_t,
...
pub unsafe extern "C" fn ts_subtree_balance(mut self_0: Subtree,
    ...
    if ts_subtree_child_count(self_0) > 0 as libc::c_int as libc::c_uint &&
        ...
        *(*pool).tree_stack.contents.offset(fresh67 as isize) =
...
pub unsafe extern "C" fn ts_subtree_release(mut pool: *mut SubtreePool,
    ...
    if atomic_dec(&(*self_0.ptr).ref_count as *const uint32_t as
        ...
        (*pool).tree_stack.size = (*pool).tree_stack.size.wrapping_add(1);
        *(*pool).tree_stack.contents.offset(fresh69 as isize) =
            ts_subtree_to_mut_unsafe(self_0)
    }
    while (*pool).tree_stack.size > 0 as libc::c_int as libc::c_uint {
        (*pool).tree_stack.size = (*pool).tree_stack.size.wrapping_sub(1);
...
unsafe extern "C" fn ts_subtree_pool_free(mut self_0: *mut SubtreePool,
    ...
    if (*self_0).free_trees.capacity > 0 as libc::c_int as libc::c_uint &&
        ...
        *(*self_0).free_trees.contents.offset(fresh71 as isize) =
...
unsafe extern "C" fn ts_tree_cursor_iterate_children(mut self_0:
 ...
 -> CursorChildIterator {
    if (*self_0).stack.size.wrapping_sub(1 as libc::c_int as libc::c_uint) <
        ...
        __assert_fail(b"(uint32_t)(&self->stack)->size - 1 < (&self->stack)->size\x00"
                          as *const u8 as *const libc::c_char,
                      b"././tree_cursor.c\x00" as *const u8 as
                          *const libc::c_char,
...
pub unsafe extern "C" fn ts_tree_cursor_init(mut self_0: *mut TreeCursor,
    ...
    (*self_0).stack.size = 0 as libc::c_int as uint32_t;
    array__grow(&mut (*self_0).stack as *mut C2RustUnnamed_23 as
                    *mut VoidArray, 1 as libc::c_int as size_t,
                ::std::mem::size_of::<TreeCursorEntry>() as libc::c_ulong);
...
pub unsafe extern "C" fn ts_tree_cursor_delete(mut _self: *mut TSTreeCursor) {
    ...
    array__delete(&mut (*self_0).stack as *mut C2RustUnnamed_23 as
                      *mut VoidArray);
}
 ...
 -> int64_t {
    ...
    loop  {
        ...
        while ts_tree_cursor_child_iterator_next(&mut iterator, &mut entry,
            ...
            if at_goal {
                if visible {
                    array__grow(&mut (*self_0).stack as *mut C2RustUnnamed_23
                                    as *mut VoidArray,
                                1 as libc::c_int as size_t,
                                ::std::mem::size_of::<TreeCursorEntry>() as
                                    libc::c_ulong);
                    ...
                    *(*self_0).stack.contents.offset(fresh75 as isize) =
                        entry;
...
pub unsafe extern "C" fn ts_tree_cursor_copy(mut _cursor: *const TSTreeCursor)
 -> TSTreeCursor {
    ...
    array__splice(&mut (*copy).stack as *mut C2RustUnnamed_23 as
                      *mut VoidArray,
                  ::std::mem::size_of::<TreeCursorEntry>() as libc::c_ulong,
 ...
 -> *mut TSRange {
    ...
    *count =
    ...
    array__delete(&mut included_range_differences as *mut TSRangeArray as
                      *mut VoidArray);
    array__delete(&mut cursor1.stack as *mut C2RustUnnamed_23 as
                      *mut VoidArray);
    array__delete(&mut cursor2.stack as *mut C2RustUnnamed_23 as
                      *mut VoidArray);
    return result;
}
/* *******************/
