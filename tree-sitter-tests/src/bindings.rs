...
impl Parser {
    ...
    pub fn print_dot_graphs(&mut self, file: &impl AsRawFd) {
        ...
        unsafe { ffi::ts_parser_print_dot_graphs(self.0.as_ptr(), libc::dup(fd)) }
    }
...
impl Query {
    ...
    pub fn new(language: Language, source: &str) -> Result<Self, QueryError> {
        ...
        for i in 0..pattern_count {
            ...
            for p in predicate_steps.split(|s| s.type_0 == type_done) {
                if p.is_empty() {
                    continue;
                }

                if p[0].type_0 != type_string {
                ...
                match operator_name.as_str() {
                    "eq?" | "not-eq?" => {
                        ...
                        text_predicates.push(if p[2].type_0 == type_capture {
    ...
    fn parse_property(
        ...
        if args[i].type_0 == bindings::TSQueryPredicateStepType_TSQueryPredicateStepTypeCapture {
